...
urls.append(f'''<url><loc>https://orv.pages.dev/donate</loc><priority>0.75</priority></url>''')
urls.append(f'''<url><loc>https://orv.pages.dev/download</loc><priority>0.7</priority></url>''')
...
urls_txt.append("https://orv.pages.dev/donate")
urls_txt.append("https://orv.pages.dev/download")
